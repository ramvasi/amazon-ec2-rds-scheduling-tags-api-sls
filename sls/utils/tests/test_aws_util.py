...
import sls.utils.tests.mock_env
...
class TestUtilities(unittest.TestCase):
    ...
    @patch("sls.utils.api_request.get_secret_value")
    ...
    def test_get_credentials(self, mock_req):
        ...
        assert value.get("AccessKeyId") == "mock"

    # Tests for aws_sm.py
    @patch("sls.utils.aws_sm.default_client")
    def test_retrieve_secret(self, mock_client):
        ...
        return_secret = retrieve_secret("Test")
        assert return_secret == "mockPwd"
